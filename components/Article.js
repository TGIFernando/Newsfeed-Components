...
*/
function articleMaker(titlee, datee, firstParagraphh, secondParagraphh, thirdParagraphh) {
    ...
    p1.textContent = firstParagraphh
    p2.textContent = secondParagraphh
    p3.textContent = thirdParagraphh
    buttn.textContent = '+'
